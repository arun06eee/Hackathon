...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'track@xpertii-onair.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'XONAIR';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'www.xpertii-onair.com';
   ...
   * @var string
   */
  public $Username      = 'track@xpertii-onair.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'great480';
